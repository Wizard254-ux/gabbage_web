...
export const organizationService = {
  ...
  editDriverWithDocuments: async (driverId: string, formData: FormData) => {
    const response = await api.post(
      `/organization/drivers/${driverId}/update`,
      formData,
      {
        headers: {
          "Content-Type": "multipart/form-data",
  ...
  sendDriverCredentials: async (driverId: string) => {
    const response = await api.post(
      `/organization/drivers/${driverId}/send-credentials`
    );
    return response;
  },
  ...
  deleteDriverDocument: async (driverId: string, documentPath: string) => {
    const response = await api.delete(
      `/organization/drivers/${driverId}/documents`,
      {
        data: { documentPath },
      }
    );
  ...
  deleteClientDocument: async (clientId, documentPath) => {
    console.log(
      "📄 Deleting document for client ID:",
      clientId,
      "path:",
      documentPath
    );
    console.log("📄 Request data:", { documentPath });
    const response = await api.delete(
      `/organization/clients/${clientId}/documents`,
      {
        data: { documentPath },
      }
    );
  ...
  getClientPayments: async (clientId, params = {}) => {
    console.log(
      "💳 Fetching payments for client ID:",
      clientId,
      "params:",
      params
    );
    const response = await api.get(
      `/organization/clients/${clientId}/payments`,
      { params }
    );
  ...
  getClientInvoices: async (clientId, params = {}) => {
    console.log(
      "🧾 Fetching invoices for client ID:",
      clientId,
      "params:",
      params
    );
    const response = await api.get(
      `/organization/clients/${clientId}/invoices`,
      { params }
    );
  ...
  resendInvoices: async (invoiceIds) => {
    ...
    const response = await api.post("/organization/invoices/resend", {
  ...
  getAgingSummary: async (params) => {
    ...
    const response = await api.get("/organization/invoices/aging-summary", {
      params,
    });
  ...
  exportAgingSummary: async (params) => {
    ...
    const response = await api.get(
      "/organization/invoices/aging-summary/export",
      {
        params,
        responseType: "blob",
      }
  ...
  getPaymentHistory: async (accountNumber, params = {}) => {
    console.log(
      "💰 Fetching payment history for account:",
      accountNumber,
      "params:",
      params
    );
    const response = await api.get(
      `/organization/payments/account/${accountNumber}`,
      { params }
    );
  ...
  updatePickupStatus: async (pickupId, data) => {
    console.log(
      "✏️ Updating pickup status for ID:",
      pickupId,
      "with data:",
      data
    );
  ...
  getBagDistributionHistory: async (params = {}) => {
    ...
    const response = await api.get("/organization/bags/issues/list", {
      params,
    });
  ...
  toggleClientStatus: async (clientId: string | number, isActive: boolean) => {
    ...
    const response = await api.post(
      `/organization/clients/${clientId}/toggle-status`,
      { isActive }
    );
  ...
  toggleDriverStatus: async (driverId: string | number, isActive: boolean) => {
    ...
    const response = await api.post(
      `/organization/drivers/${driverId}/toggle-status`,
      { isActive }
    );
