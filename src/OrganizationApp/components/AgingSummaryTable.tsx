...
export const AgingSummaryTable: React.FC<AgingSummaryTableProps> = ({
  ...
  const totalCount = agingBuckets.reduce(
    ...
    <div className="bg-white rounded-lg shadow mb-6">
      ...
      <div className="p-4">
        {totalUnpaidAmount === 0 ? (
          <div className="text-center py-8 text-gray-500">
            ...
            <div className="text-sm">
              All invoices are either paid or still within grace period.
            </div>
          </div>
        ) : (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-blue-50 rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-blue-600">
                  {totalCount > 0
                    ? formatCurrency(Math.round(totalUnpaidAmount / totalCount))
                    : "KES 0"}
                </div>
        ...
        <div className="mt-4 text-xs text-gray-500">
          *{" "}
          {message ||
            `Aging calculation starts after ${gracePeriodDays}-day grace period from due date`}
        </div>
      </div>
    </div>
  );
